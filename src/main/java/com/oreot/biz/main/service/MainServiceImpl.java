...
import com.oreot.biz.main.dao.MainDAO;
...
public class MainServiceImpl implements MainService{
	...
	public void updateMemberInfo(MainVO vo) {
		System.out.println("updateMemberInfo 호출1");
		...
		userVO.setMemberName(vo.getMemberName()); //상화_2월7일 vo.getMemberId()에서 수정
		userVO.setMemberNum(vo.getMemberNum());  //상화_2월7일 추가
