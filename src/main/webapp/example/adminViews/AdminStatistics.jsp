			...
			<div class="container-fluid">
				...
				<div class="panel panel-headline">
					<div class="panel-heading">
						<div class="row">
							<div class="col-md-12">
								<h3 class="panel-title">분류별 통계</h3>
								<div class="right">
							...
							<div class="col-md-12">
								<div class="row">
									...
									<div class="col-md-12">
										<div class="firsttab">
										  <button class="tablinks" onclick="openCity(event, 'sales')" id="defaultOpen">매출</button>
										  <button class="tablinks" onclick="openCity(event, 'member')">회원</button>
										  <button class="tablinks" onclick="openCity(event, 'search')">검색</button>
										</div>
									</div>
									
									<div id="sales" class="col-md-12 secondtab">
										<button type="button" class="btn btn-default">기간별</button>
										<button type="button" class="btn btn-default" >지역별</button>
										<button type="button" class="btn btn-default">평수별</button>
									</div>
									
									<div id="member" class="col-md-12 secondtab">
										<button type="button" class="btn btn-default">사용자별</button>
										<button type="button" class="btn btn-default" >연령대별</button>
										<button type="button" class="btn btn-default">성별</button>
									</div>
									
									<div id="search" class="col-md-12 secondtab">
										<br>
									</div>
									 -->
									<div class="col-md-12">
...
$(function()
{
	...
	google.charts.setOnLoadCallback(pieMonthlySales);
	google.charts.setOnLoadCallback(memCateCount);
	google.charts.setOnLoadCallback(memGenderCount);
	...
	function memCateCount() {
		var data = google.visualization.arrayToDataTable([
		['Member Category', 'Member Count'],
		['호스트', ${memCateCount.host}],
		['게스트', ${memCateCount.guest}],
		['유령', ${memCateCount.ghost}]
		]);

		// Optional; add a title and set the width and height of the chart
		var options = {title:'유형별 회원수', 'width':700, 'height':700};
	...
	function memGenderCount() {
		var data = google.visualization.arrayToDataTable([
		['Gender', 'Gender Count'],
		['남자', ${memGenderCount.men}],
		['여자', ${memGenderCount.women}]
		]);

	  // Optional; add a title and set the width and height of the chart
	  var options = {title:'회원 성별 비율', 'width':700, 'height':700};
