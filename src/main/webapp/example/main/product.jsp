					...
					<div class="col-lg-6">
						<div class="product-pic-zoom">
							<img class="product-big-img"
								src="img/product-single/product-1.jpg" alt="">
							<div class="zoom-icon">
					...
					<div class="col-lg-6">
						<div class="product-details">
							...
							<div class="quantity">
								...
								<a href="cart.do" class="primary-btn pd-cart">ㅁㅁ</a>
							</div>
							<div class="quantity">
								<a href="cart.do" class="primary-btn pd-cart">장바구니</a>
								
								<a href="cart.do" class="primary-btn pd-cart" style="margin-left: 2px;">결제하기</a>
							</div>
							<ul class="pd-tags">
								<li>
